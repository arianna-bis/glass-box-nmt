...
def getData(size1, size2,size3, lang, feature):
	[X, crossValX, X2, XLabels, crossValLabels, X2Labels, trainWords, testWords] = getTCTSets(size1, size2, size3, lang, feature)
...
def train(C, maxiter, tol, X, XLabels):
	...
	logreg = neural_network.MLPClassifier(verbose=True,hidden_layer_sizes=(100, ), 
				activation='relu', solver='lbfgs') # alpha=C, learning_rate_init = 0.0001, beta_1 = 0.9, epsilon = 10e-8)
